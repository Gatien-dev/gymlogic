        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    user.PreviousConnectionDate = user.LastConnectionDate;
                    ...
                    {
                        this.AddToastMessage("Abonnements presque terminés.", "Certains abonnements sont expirés ou presque.Merci de consulter les abonnements.");
                    }
                ...
                default:
                    ...
                    return View("LoginNoLayout", model);
            }
        }
